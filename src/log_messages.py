...
REMOVE_USER_FROM_STAFF_CHANNEL_FAILED = "User was not removed from staff group channel."
ADD_USER_TO_STAFF_CHANNEL_FAILED = "User was not added to staff group channel."
